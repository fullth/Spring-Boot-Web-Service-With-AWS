...
nohup java -jar \
    -Dspring.config.location=classpath:/application-prod.properties,/home/ec2-user/app/application-oauth.properties,/home/ec2-user/app/application-prod-db.properties \
